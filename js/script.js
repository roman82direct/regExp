...
const regExp = /(\s)'|'(\s)|'$/g //(\s)' после пробела или '(\s) до пробела или '$ в конце строки g поиск по всему тексту. \s в скобках для группировки, чтобы сохранить перенос строки
